...
class Pinjam extends CI_Controller
{
    ...
    public function pinjamAct()
    {
        ...
        //update dibooking dan pinjam pada tabel buku saat buku yang dibooking diambil untuk dipinjam
    ...
    public function ubahStatus()
    {
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-message alert-success" rolo="alert"></div>');
        redirect(base_url('pinjam'));
    }
}
